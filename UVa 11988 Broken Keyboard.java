    ...
    public static void main(String[] args){
        ...
        while((line = reader.nextLine()) != null){
            ...
            for(int i=0;i<c.length;i++){
                if(c[i] == '[' || c[i] == ']'){
                    if(home)    list.addFirst(line.substring(last, i));
                    else list.addLast(line.substring(last, i));
                    last = i+1;
                    if(c[i] == '[')
                        home = true;
                    else
            ...
            if(last < c.length) {
                if (home) list.addFirst(line.substring(last, c.length));
                else list.addLast(line.substring(last, c.length));
            }
            for(String s : list){
                writer.print(s);
            }
